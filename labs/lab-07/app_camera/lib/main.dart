    ...
    return Scaffold(
      ...
      body: Column(
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    'UID do usuário ${user?.uid ?? "Não autenticado"}\n'
                    'Email do usuário ${user?.email ?? "Não autenticado"}',
          ...
          //Lista de fotos já enviadas para o usuário
          Expanded(
            child: ListView.builder(
              itemBuilder: (context, index) {
                return ListTile(
                  title: Text('Foto $index'),
                  subtitle: Text('URL da foto $index'),
                );
              },
              itemCount: 0,
            ),
